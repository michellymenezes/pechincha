...
public class HerokuGetSalesByMarketTask extends AsyncTask {
    private static final String TAG = "HEROKU_GET_SALES_BY_MARKET_TASK";

    private ArrayList<Sale> sales;
    private String responseMessage = "";
    private String endpoint, marketId;
    private SaleListener mListener;


    public HerokuGetSalesByMarketTask(String marketId, String url, SaleListener listener) {
        endpoint = url;
    ...
    protected Boolean doInBackground(Object... params) {
        URL url;
        try {
            url = new URL(endpoint + "?market=" + marketId);
    ...
    protected void onPostExecute(Object o) {
        ...
        if (sales != null) {
            mListener.OnGetSalesByMarketReady(true, this.sales);
        } else {
            mListener.OnGetSalesByMarketReady(false, this.sales);
        }
    }
