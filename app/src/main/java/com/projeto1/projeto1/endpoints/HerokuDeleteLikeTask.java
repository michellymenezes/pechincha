...
public class HerokuDeleteLikeTask extends AsyncTask<Void, Void, Boolean> {
    private static final String TAG = "HEROKU_DELETE_LIKE_TASK";
    ...
    public HerokuDeleteLikeTask(String saleId, String userId, Context context, String endpoint, SaleListener mListener) {
    ...
    protected void onPostExecute(Boolean success) {
        ...
        if (isSuccessfulRegister) {
            Toast.makeText(context, "Like removido com sucesso", Toast.LENGTH_LONG).show();
            mListener.OnDeleteLikeFinished(true, sale);
        }
        else {
            mListener.OnDeleteLikeFinished(false, sale);
        }
