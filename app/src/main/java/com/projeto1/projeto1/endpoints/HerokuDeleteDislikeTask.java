...
public class HerokuDeleteDislikeTask extends AsyncTask<Void, Void, Boolean> {
    private static final String TAG = "HEROKU_DELETE_DISLIKE_TASK";
    ...
    public HerokuDeleteDislikeTask(String saleId, String userId, Context context, String endpoint, SaleListener mListener) {
    ...
    protected void onPostExecute(Boolean success) {
        ...
        if (isSuccessfulRegister) {
            Toast.makeText(context, "Dislike removido com sucesso", Toast.LENGTH_LONG).show();
            mListener.OnDeleteDislikeFinished(true, sale);
        }
        else {
            mListener.OnDeleteDislikeFinished(false, sale);
        }
